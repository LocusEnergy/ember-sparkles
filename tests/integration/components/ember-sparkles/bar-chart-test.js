...
test('it accepts data and generates rectangles', function(assert) {
  ...
  assert.deepEqual(this.chart.getAttr('width'), ['25', '25', '25', '25'], 'each rect has a width attribute, all width values are equal');
  assert.deepEqual(this.chart.getAttr('height'), ['9', '42', '65', '17'], 'each rect has a properly calculated height attribute');
});
//
// skip('data can be updated and removed', function(assert) {
//   let data = [ [ '2016-03-02T00:00:00', 9], ['2016-03-03T00:00:00', 42], ['2016-03-04T00:00:00', 65], ['2016-03-05T00:00:00', 17] ];
//   this.set('data', data);
//
//   this.set('xDomain', data.map(d => d[0]));
